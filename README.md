...
- Buildings input often requires cleaning (repairing geometries) in a GIS before use.
- Additional filter categories exist (e.g., parking, hotels, tourism, EV charging, mailbox). Not all are currently used in the attractiveness aggregation, but they can be useful for other analyses.
